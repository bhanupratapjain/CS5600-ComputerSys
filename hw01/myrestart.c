...
//			printf("Incorrect Data Length Read.\n");
		...
		if (mprotect(new_mem, mem_size,
				get_memory_protection(perms)) < 0) {
...
//	checkpoint_flag_ptr = (int *)checkpoint_flag_addr;
...
//	printf("sp:%p\n", stack_ptr);
//TODO:: Where to point program counter, top or bottom.
